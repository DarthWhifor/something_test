...
@if(can('view_categories') || can('view_products'))
<x-nav.group label="Shop" route="admin.products" icon="fas fa-cogs">
    <x-nav.group-item route="admin.products.list-categories" icon="far fa-circle">Categories</x-nav.group-item>

    <x-nav.group-item route="admin.products.list-products" icon="far fa-circle">Products</x-nav.group-item>
